...
Instructions for AI coding agents working on kash-shell. (This file follows the
...
`uv run python -m kash_shell`.

## Conventions

- **Layout**: `src/` layout; code in `src/kash_shell/`, tests in `tests/`.
